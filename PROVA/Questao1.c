...
prova. O código criado para solucionar esta questão deve ser anexado à prova.
...
Exemplo de decodificação Supondo que o valor da mensagem codificada C e da chave K sejam
 C = {18, 17, 14, 4, 12, 0,
*/
#include <stdio.h>
#include <stdlib.h>
...
int main()
{
    ...
    char chave[20];
    char mensagem[200];
    int tamanho_mensagem = 200, tamanho_chave, i;
    char arquivo_nome[30];

    printf("Digite o numero de matricula: ");
    scanf("%s", chave);

    // criar o nome do arquivo a partir da chave
    sprintf(arquivo_nome, "%s.dat", chave);
